                         ...
                         <div class="panel-body center-block">
                           ...
                           <form role="form" method="post" action="/login/register">
                              <fieldset>
                                ...
                                <div class="form-group col-lg-12">
                                    <label>Mision de prueba:</label>
                                    <select class="form-control" name="communes" required>
									 	<?php
									 		echo '<option value="">Aca se muestran las misiones para ver si funcionan</option>';
									 		foreach($mission as $mision)
												{
