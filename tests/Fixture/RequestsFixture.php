...
class RequestsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'nombre_solicitud' => ['type' => 'string', 'length' => 100, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'requests_ibfk_1' => ['type' => 'foreign', 'columns' => ['task_id'], 'references' => ['tasks', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
    ...
    public $records = [
        [
            ...
            'task_id' => 1,
            'user_id' => 1,
            'nombre_solicitud' => 'Lorem ipsum dolor sit amet',
            'estado' => 1
        ],
    ];
}
