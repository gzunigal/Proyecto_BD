...
class AbilitiesUsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'abilities_users_ibfk_1' => ['type' => 'foreign', 'columns' => ['ability_id'], 'references' => ['abilities', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
            'abilities_users_ibfk_2' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
